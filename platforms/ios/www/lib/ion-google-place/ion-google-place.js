                ...
                link: function(scope, element, attrs, ngModel) {
                        ...
                        '<div class="ion-google-place-container">',
                            '<div class="bar bar-header item-input-inset">',
                                '<label class="item-input-wrapper">',
                                    ...
                                    '<input class="google-place-search" style="color :#000000;" type="search" ng-model="searchQuery" placeholder="Enter an address, place or ZIP code">',
                                '</label>',
                    ...
                    popupPromise.then(function(el){
                        ...
                        scope.selectLocation = function(location){
                            ...
                            console.log('location:',location.geometry.bounds);
                            console.log('location:',location.geometry.location.lat());
                            console.log('location:',location.geometry.location.lng());

                              /*  var jj = new google.maps.Map.getBounds(location.geometry.bounds)
                            console.log('jj:',jj);*/
                        ...
                        scope.$watch('searchQuery', function(query){
                            ...
                            searchEventTimeout = $timeout(function() {
                              ...
                              /*  geocoder.geolocation({address: query},function(results, status){
